...
# training the model
def train_evaluate_model(X, Y, labels, model):
    # train test split
...
def main():
    if len(sys.argv) ==3:
        ...
        print('Training and evaluate model...')
        model = train_evaluate_model(X, Y, labels, model)  # train and evaluate model pipeline
        print('Saving model...')
